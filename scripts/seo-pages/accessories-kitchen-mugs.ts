...
const content: PageSEOContent = {
  url_path: '/accessories/kitchen/mugs',

  meta_title: 'Equestrian Mugs | Horse Theme Cups',
  meta_description:
    'Horse-themed mugs for everyday drinks. Glassware and trays sit on sibling kitchen pages. Shop Australia-wide with clear product details.',
  h1_title: 'Equestrian Mugs',
  breadcrumb_label: 'Mugs',

  short_description: `<p>Browse <strong>equestrian mugs</strong>: Mugs and cups with horse motifs for everyday drinking, not wine glass sets.</p>
<!--read-more-trigger-->
...
<p>Compare sibling leaves when the job changes rather than treating every horse motif as the same product. Stay here when the listing matches this object type. Check care notes and dimensions on the product page before you buy, and expect Australian shipping options at checkout for each vendor listing.</p>`,
  ...
  long_description: `<h2>What Are Equestrian Mugs?</h2>
<p>Mugs and cups with horse motifs for everyday drinking, not wine glass sets.</p>
<p>Typical pieces include:</p>
<ul>
<li>Everyday mugs</li>
<li>Horse and discipline motifs</li>
<li>Kitchen drinkware</li>
</ul>

<h2>Equestrian Mugs vs Glassware</h2>
<p>Glassware covers wine and tumbler sets. Mugs are everyday cups. See <a href="/accessories/kitchen/glassware">glassware</a>.</p>

<h2>Equestrian Mugs vs Trays</h2>
<p>Trays carry items. Mugs hold drinks. See <a href="/accessories/kitchen/trays">trays</a>.</p>

<h2>Equestrian Mugs vs Cushions</h2>
<p>Cushions are soft furnishings. Mugs are drinkware. See <a href="/accessories/homeware/cushions">cushions</a>.</p>

<h2>Related Accessories</h2>
<p>Barware is openers and holders, not mugs. Compare <a href="/accessories/kitchen/barware">barware</a>.</p>
...
<p>Mixed leftovers without this type stay on <a href="/accessories/gifts">equestrian gifts</a>.</p>`,
  ...
  faq_items: [
    {
        question: "What belongs on the mugs page?",
        answer: "Mugs and cups with horse motifs for everyday drinking, not wine glass sets. Sibling leaves cover related but different jobs. Choose by the product type and how you will use the piece at home. Read the product title and dimensions before you buy. Australian delivery options appear at checkout for each vendor listing."
    },
    {
        question: "How is this different from the gifts hub?",
        answer: "Gifts holds mixed present-scale leftovers. This leaf is for typed equestrian mugs. When the listing matches this type, shop here so you compare like with like. Read the product title and dimensions before you buy. Australian delivery options appear at checkout for each vendor listing."
    },
    {
...
export const frameworkNotes: SubcollectionFrameworkNotes = {
  centralEntity: 'equestrian mugs',
  primaryAngle:
    'Mugs and cups with horse motifs for everyday drinking, not wine glass sets.',
  informationGain: [
  ...
  overlapSplit: `equestrian mugs vs siblings on homeware and kitchen.`,
