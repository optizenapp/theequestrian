 ...
 * 
 * Checks the shopify_price_audit table to verify:
 * 1. Original prices before offset
 * 2. Shipping offsets applied
 * 3. Final adjusted prices
 */

import { config } from 'dotenv';
import { resolve } from 'path';

// Load from shopify-price-offset service .env
config({ path: resolve(process.cwd(), 'services/shopify-price-offset/.env') });
