  ...
  return (
    <AdminLayout title="Email Platform" subtitle="Contacts, campaigns, segments, and sequences">
      <div className="mb-4 flex flex-wrap gap-2">
        ...
        <Link href="/admin/email/auto-campaigns" className="rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm font-semibold text-sky-900 hover:border-action hover:text-action">Auto campaigns</Link>
      ...
      <div className="mt-6 rounded-2xl border border-sky-200 bg-sky-50/30 p-5 shadow-sm">
        <h3 className="text-sm font-semibold text-sky-900">Auto campaigns</h3>
        <p className="mt-1 text-sm text-sky-800">
          Configure the 3-type weekly builder (brand / on-sale / category), rotation, resends, and test triggers on the dedicated screen.
        </p>
        <Link
          href="/admin/email/auto-campaigns"
          className="mt-3 inline-flex rounded-full bg-action px-4 py-2 text-sm font-semibold text-white hover:bg-pink-600"
        >
          Open Auto campaigns
        </Link>
      </div>
