...
/**
 * Footer Component (Back Market style)
 * 
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © {currentYear} The Equestrian. All rights reserved.
            </p>
            
            {/* Social Links */}
            <div className="flex space-x-6">
              <a
                href="https://www.facebook.com/attheequestrian"
                target="_blank"
              ...
              <a
                href="https://instagram.com/theequestrianoz"
                target="_blank"
                rel="noopener noreferrer nofollow"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://www.youtube.com/channel/UCvcpt-fRaAY4PBavZicia1g"
                target="_blank"
                rel="noopener noreferrer nofollow"
                className="text-gray-400 hover:text-white transition-colors"
